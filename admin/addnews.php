...
<?php include 'layouts/header.php';
 ...
 if(isset($_POST['savebtn']))
 {
 	...
 	if(insertProgram($conn,$_POST))
 	{
 		...
 		showMsg('News Created Successfully.','success');
...
?>
		...
		<div class="page-header">
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1" required><b>TV News Title:</b> </label>
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data" >
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <b>News Description:</b> </label>
