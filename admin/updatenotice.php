...
$userId = $_GET['ref'];
$user = getNoticeById($conn,$userId);
 ...
 if(isset($_POST['savebtn']))
 {
 	if (!empty($_FILES["file"]['tmp_name']))
 	{
 		...
 		$_POST['image_path']=uploadNoticeImage('uploads',$_FILES['file']);
 		@unlink("uploads/".$user['image_path']);
 	}

 	if(updateNotice($conn,$_POST))
 	{
...
?>
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <b>Notice Title:</b> </label>
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <b>Notice Description:</b> </label>
            ...
            <script>
                ...
                CKEDITOR.add
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <strong>Date: </strong></label>

						<div class="col-sm-9">
							<input type="date" name="created_date" class="btn btn-success"  value="<?php echo $user['created_date'];?>" required="">
