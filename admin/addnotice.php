...
<?php include 'layouts/header.php';
 ...
 if(isset($_POST['savebtn']))
 {
 	...
 	if(insertNotice($conn,$_POST))
 	{

 		showMsg('Notice Created Successfully.','success');
			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="POST" role="form" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1" required><b>Notice Title:</b> </label>
            ...
            <script>
                ...
                CKEDITOR.add
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="date" name="created_date" class="btn btn-success" required="">
