		...
		<th class="hidden-480">News Description</th>
		<th>Image</th>
		<th>Date</th>
	   ...
	   <?php $users = getAllPrograms($conn);
		...
		<td>
			<?php echo $string=substr($user['tv_title'],0,50)."....."; ?>
		</td>
		...
		<td>
			<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
				...
				<a class="green" href="updatenews.php?ref=<?php echo $user['id']; ?>">
					<i class="icon-pencil bigger-130"></i>
				</a>

				<a class="red" href="deletenews.php?ref=<?php echo $user['id']; ?>" onclick="return confirm('Are You Sure to Delete ?');">
