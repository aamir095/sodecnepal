                    ...
                    <div class="col-md-3 sidebar left-sidebar">
                        ...
                        <div style="background-color: #CCCCFF" class="widget widget-categories">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="team.html" class="main">Our Team</a>
                                </li>
                    ...
                    <div class="col-md-9 blog-box">
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title ">Core Team</h3>
                            </div>
                            <table class="table team-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><strong>Dr Pius Raj Mishra</strong></td>

                                    </tr>

                                    <tr>
                                        <td>Program Coordinator</td>
                                        <td><strong>Mr Prakash Ghimire</strong></td>
                                        <tr>

                                            <tr>
                                                <td>Finance, Admin and Compliance Officer</td>
                                                <td><strong>Mr Ravi S Prasad</strong></td>
                                            </tr>

                                            <tr>
                                                <td>Reporting and Documentation Officer</td>
                                                <td><strong>Ms Asmita Manandhar</strong></td>
                                            </tr>

                                            <tr>
                                                <td>Office Executive</td>
                                                <td><strong>Ms Pabitra Thapaliya</strong></td>
                                            </tr>
