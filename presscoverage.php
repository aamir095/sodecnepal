...
<head>
    ...
    <!-- Basic -->
    <title>SODEC Nepal | Press Coverage</title>
                ...
                <div class="portfolio-details">
                  <a href="#">
                    ...
                    <div class="col-md-9 blog-box">
                        ...
                        <div class="grid">
                            <a target="_blank" href="images/press/6.jpg">
                                <div class="grid-item">
                                    <div class="overlay"></div>
                                    <img alt="" src="images/press/6_thumb.jpg" />
                                </div>
                            </a>
                            <a target="_blank" href="images/press/6\4.jpg">
                                <div class="grid-item">
                                    <div class="overlay"></div><img alt="" src="images/press/4_thumb.jpg" /></div>
                            </a>
                            <a target="_blank" href="images/press/8.JPG">
                                <div class="grid-item">
                                    <div class="overlay"></div><img alt="" src="images/press/8_thumb.jpg" /></div>
                            </a>
                            <a target="_blank" href="images/press/1.jpg">
                                <div class="grid-item">
                                    <div class="overlay"></div><img alt="" src="images/press/1_thumb.jpg" /></div>
                            </a>
                            <a target="_blank" href="images/press/2.jpg">
                                <div class="grid-item">
                                    <div class="overlay"></div><img alt="" src="images/press/2_thumb.jpg" /></div>
                            </a>
                            <a target="_blank" href="images/press/3.jpg">
                                <div class="grid-item">
                                    <div class="overlay"></div><img alt="" src="images/press/3_thumb.jpg" /></div>
                            </a>

                            <a target="_blank" href="images/press/5.jpg">
                                <div class="grid-item">
                                    <div class="overlay"></div><img alt="" src="images/press/5_thumb.jpg" /></div>
                            </a>
                            <a target="_blank" href="images/press/7.jpg">
                                <div class="grid-item">
                                    <div class="overlay"></div><img alt="" src="images/press/7_thumb.jpg" /></div>
                            </a>
