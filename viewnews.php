...
<head>
  ...
  <meta name="description" content="SODEC Nepal">
...
<script type='text/javascript' src='//platform-api.sharethis.com/js/sharethis.js#property=5994fb34fb9b6e00129cd2d6&product=social-ab' async='async'></script>
      ...
      <div class="container">
        ...
        <div class="recent-projects">
          ...
          <div class="col-md-9 blog-box">
            ...
            <h3 class="red-text"><?php echo $news['tv_title'];?></h3>
				<img src="admin/uploads/<?php  echo $news['image_path'];?>" alt=""></br>
            ...
            <p><?php echo $news['tv_description'];?></p>
