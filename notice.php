...
<link rel="shortcut icon" href="images/favicon.ico" type="image/x-icon">
  ...
  <!-- SODEC Nepal JS  -->
  <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/6D17F271-7CB1-BA4B-A76F-21180704FBE8/main.js" charset="UTF-8"></script><script type="text/javascript" src="js/jquery-2.1.4.min.js"></script>
 ...
 -->
          ...
          <div class="col-md-9 blog-box">
            ...
            <!-- Start Post -->
             ...
             <?php $allnewss=getNoticeInPage($conn);
       ...
       ?>
            <div class="blog-post standard-post">
			  ...
			  <div class="post-content">
                ...
                <h2><a href="view-notice.php?ref=<?php echo $allnews['id'];?>"><font color="blue"><?php  echo $allnews['tv_title'];?></font></a>
                <ul class="post-meta">
                  <li><?php  echo $allnews['created_date'];?></li>
                 
                </ul>
                <p><?php  echo $string=substr($allnews['tv_description'],0,150)."....."; ?></p>
                <a class="main-button" href="view-notice.php?ref=<?php echo $allnews['id'];?>">Read More <i class="fa fa-angle-right"></i></a>
              </div>
          ...
          <?php } ?>
            ...
            <!-- Start Pagination -->
            <div id="pagination">
              <span class="all-pages">Page 1 of 1</span>
