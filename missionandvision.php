...
<head>
  ...
  <!-- Basic -->
  <title>SODEC Nepal | Vision & Mission</title>
...
<body>
            ...
            <div style="background-color: #CCCCFF" class="widget widget-categories">
              ...
              <ul>
                <li>
                 ...
                 <li>
                  <a href="#" class="main">Vision &  Mission </a>
                </li>
                <li>
 ...
 -->
          ...
          <div class="col-md-9 blog-box">
            ...
            <p>SODEC envisions the democratically egalitarian society in the new Nepal, where the governance is just and development
              is a right available to each and every citizen, regardless of race, caste, ethnicity, gender, or the region
              where one comes from.</p>
            ...
            <!-- Some Text -->
            <p>The mission of organization is to identify the root causes of social discriminations, inequities, and injustices
              which have been suppressing the Nepalese society, and to actively campaign against them to create a just and
              equitable society.</p><br>
